...
m1_rght = np.asarray( [199, -601] )

m2_lft = np.eye(5) * 1000.48

m2_rght = np.asarray( [2000.96, 2000.96, 2000.96, 2000.96, 2000.96] )
...
m4_rght = np.asarray( [4.0001, 4.0001, 4.0001, 4.0001, 4.0001, 4.0001, 4.0001, 4.0001, 4.0001] )

hilbert_rght = np.asarray( [201, 399, 112, 487, 749] )
